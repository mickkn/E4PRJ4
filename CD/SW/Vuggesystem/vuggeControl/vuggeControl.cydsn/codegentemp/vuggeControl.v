...
module top ;
    ...
    UART_v2_40_4 debugOut (
        ...
        .reset(Net_3465),
        .rx(1'b0),
        .tx_interrupt(Net_3560),
        .rx_interrupt(Net_3561),
        .tx_data(Net_3562),
        .tx_clk(Net_3563),
        .rx_data(Net_3564),
        .rx_clk(Net_3565));
