...
#define I2C_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
    ...
    #define I2C_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << I2C_SPI_CTRL_SSEL_POLARITY0_POS)
    #define I2C_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << I2C_SPI_CTRL_SSEL_POLARITY1_POS)
    #define I2C_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << I2C_SPI_CTRL_SSEL_POLARITY2_POS)
    #define I2C_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << I2C_SPI_CTRL_SSEL_POLARITY3_POS)
