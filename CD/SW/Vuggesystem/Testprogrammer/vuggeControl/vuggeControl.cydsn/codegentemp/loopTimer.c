...
{
   #if(loopTimer_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(loopTimer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG8(loopTimer_PERIOD_LSB_PTR));
   #endif /* (loopTimer_UsingFixedFunction) */
}
...
void loopTimer_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(loopTimer_PERIOD_LSB_PTR, period);
...
{
   #if(loopTimer_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(loopTimer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG8(loopTimer_CAPTURE_LSB_PTR));
   #endif /* (loopTimer_UsingFixedFunction) */
}
...
void loopTimer_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(loopTimer_COUNTER_LSB_PTR, counter);
