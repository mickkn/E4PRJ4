 ...
 *****************************************************************/
I2Csocket::I2Csocket(void){

	system("/home/pi/scripts/gpio_load_i2c.sh");
	usleep(1000000);
...
I2Csocket::I2Csocket(unsigned char dev_addr, std::string i2c_file_name){
 ...
 ********************************************************************/
int I2Csocket::writeReg(unsigned char reg_addr, unsigned char data){
...
int I2Csocket::readReg(unsigned char reg_addr, unsigned char &data){
