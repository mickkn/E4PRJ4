...
\textit{n} er index for den givne fft i det totale Short-Time DFT spektogram og \textit{\verb+k+k} er index for en given frekvensbin i det nuværende fft-spektrum. \textit{K} er fft'en længde.
