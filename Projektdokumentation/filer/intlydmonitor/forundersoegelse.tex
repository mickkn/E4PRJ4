...
\figur{0.7}{intlydmonitor/forundersoegelse/analyse}{Analyseresultat af optagelsen "Højlydt babygråd"}{intlyd:forundersoegelse:høj_baby}

\newpage
\textbf{Moderat babygråd}\\
\figur{0.7}{intlydmonitor/forundersoegelse/analyse}{Analyseresultat af optagelsen "Moderat babygråd"}{intlyd:forundersoegelse:mod_baby}

\newpage
\textbf{Fuglefløjt}\\
\figur{0.7}{intlydmonitor/forundersoegelse/analyse}{Analyseresultat af optagelsen "Fuglefløjt"}{intlyd:forundersoegelse:fugl}

\newpage
\textbf{Trafikstøj}\\
\figur{0.7}{intlydmonitor/forundersoegelse/analyse}{Analyseresultat af optagelsen "Trafikstøj"}{intlyd:forundersoegelse:trafik}

\newpage
\textbf{Forsamlingsstøj}\\
\figur{0.7}{intlydmonitor/forundersoegelse/analyse}{Analyseresultat af optagelsen "Forsamlingsstøj"}{intlyd:forundersoegelse:forsamling}
