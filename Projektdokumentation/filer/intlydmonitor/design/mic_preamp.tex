...
Dette betyder altså at vi kan nøjes med at bruge en billig operationsforstærker uden større krav til SR, såsom en OpAms fra den i lydbehandling almindeligt anvendte TL071-serie ville give (SR = 13MV/s).
