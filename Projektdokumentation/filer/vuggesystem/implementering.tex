...
Idet systemet ikke kan bringes til stabilitet med et rent P led kan en traditionel Ziegler-Nichols kalibrering ikke benyttes. Det er dog muligt at udføre en lignende kalibrering hvor systemet bringes til stabil oscillation med et PD led hvor der benyttes en fast ratio mellem de to, svarende til ovennævnte medtode. herved kan en egenfrekvens bestemmes, samt en grænseforstækning, og parametrene for PID kan bestemmes.\\

\textbf{Lead/lag regulator}\\
Efter at en fungerende regulering er implementeret, kan en frekvens karakteristik af sytemet med denne regulering udføres, hvorudfra ønskede forbedringer kan laves ved brug af kendt teori om lead/lag regulering, som beskrevet i TODO: regulerings design afsnit. På denne måde kan systemet tilpasses for at tilpasse systemets regulering mere præcist, samt tilpasse MERE - nævn ikke funk krav
