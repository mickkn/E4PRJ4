...
Vuggesystemet anvender fire interrupt service rutiner: 
\begin{itemize}
\item \textbf{Endstop\_isr} forbundet med en GPIO
\item \textbf{I2CVuggesystem\_SCB\_IRQ} der foregår som et internt interrupt til I2C hardwareblokken der står for kommunikationen mellem Baby Watch Controller og Vuggesystem
\item \textbf{sensorI2C\_SCB\_IRQ} er ligeledes et internt interrupt til I2C hardwareblokken der står for kommunikationen mellem Vuggesystem og Vuggeudsvings sensor
\item \textbf{loop\_isr} er et timer interrupt
\end{itemize}
