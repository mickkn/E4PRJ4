...
De to microswitches der sikrer at vuggen ikke går ud over dens mekaniske grænser fungerer elektrisk set bare som en kontakt. Brydes enten den ene eller den anden af de to kontakter ønskes et interrupt sendt til vuggesystemets kontrol program, hvilket opnås med følgende kreds:

\figur{0.4}{vuggesystem/design/ES_kreds.pdf}{kredsløb til tilkobling af endstop sensorer}{es_kreds}

kredsløbet fungerer ved at sætte en pullup modstand på ved indgangen til PSoC'en, og kontakterne i parallel til ground. på denne måde står indgangen høj, medmindre en eller begge sensorer aktiveres, hvorved kontakten sluttes og linjen trækkes lav.\\
