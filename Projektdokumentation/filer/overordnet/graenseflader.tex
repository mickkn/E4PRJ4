...
\hline 
\multirow{5}{*}{0x01} & Status & \textbf{R} & Indeholder en bitsekvens som indikerer systemets status. Registeret indeholder følgende: [\textbf{ERR} \textbf{STALL} \textbf{END\_STP} \textbf{SD\_RDY} X X X X] et 1 tal indikerer en fejl & 0b0000XXXX \\ \cline{2-5}

	&\multicolumn {2}{p{3cm} |} {\textbf{ERR}} & \multicolumn {2}{p{8cm} |} {Indikerer at der er opstået en fejl i systemet. Vuggesystemet er deaktiveret indtil der er blevet genstartet. Kendes årsagen til fejlen indikeres denne i STALL og END\_STP} \\ \cline{2-5}
