...
\figur{0.6}{intlydmonitor/analyse_hoejlydt_babygraad_lang}{Langtids-analyse af højlydt babygråd optagelse}{intlyd:lang}
For en fuld beskrivelse af alle lydanalyser henvises til [\textit{Se projektdokumentationen pp. 72-84}]
